...
class Team:
    ...
    def time_based_substitutions(self, game_minutes_elapsed: float, restrict_to_top: int = None,
        ...
        - SUPERSTAR RULE: Players with usage_rate > 25 stay on court in close games
        - BLOWOUT RULE: Superstars can rest when up/down 20+
        ...
        is_close_game = abs(score_diff) <= 9  # Single digit = close game
        is_blowout = abs(score_diff) >= 20  # 20+ = blowout
        ...
        for i, player_idx in enumerate(self.on_court_indices):
            ...
            if is_superstar and not is_blowout:
                buffer += 2.0  # Need to be further ahead before subbing
...
class GameSimulation:
    ...
    def simulate_possession(self) -> Tuple[str, bool]:
        ...
        # Random number of passes (0-3) - track for playmaker boost and assists
    ...
    def simulate_game(self):
        ...
        for q in range(1, 5):
            ...
            if q == 2:
                ...
                # Offer substitution menu after reviewing both teams' stats
                console.print("\n[bold cyan]Would you like to adjust your lineup for the 2nd half?[/bold cyan]")
                sub_choice = Prompt.ask("Press ENTER to keep lineup, or type 'S' to substitute", default="", show_default=False)
                if sub_choice.upper() == 'S':
                    self.substitution_menu()
